...
public class UIMenu {
    ...
    private static void authUser(int userType){
        ...
        patients.add(new Patient("Ervin Rivas", "ervinR@gmail.com"));
        patients.add(new Patient("Mayra Caicedo", "mayra@gmail.com"));
        patients.add(new Patient("Emily Rivas", "emily@gmail.com"));
